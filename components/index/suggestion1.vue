<template>
  ...
  <div class="row m-auto house_slider_1_row mb-5">

    <!--Slider 1-->
    <div class="col-8"  style="padding-right: 0;direction: ltr;">
<!--      <client-only>-->
...
<!--      </client-only>-->
    ...
    <div class="col-4 slider_1_detail" style="padding-right: 40px;">
      ...
      <div class="row" style="margin-bottom: 50px;">
        <div class="col" v-bind:class="[{'text-right' : $i18n.locale == 'fa' || $i18n.locale == 'ar' },{'text-left' : $i18n.locale == 'en' || $i18n.locale == 'ru' }]">
          <span class="suggest_1_title" v-bind:class="[{'Estedad_FD_Bold' : $i18n.locale == 'fa' || $i18n.locale == 'ar' },{'Estedad_Bold' : $i18n.locale == 'en' || $i18n.locale == 'ru' }]"> {{ $t('index.spe_adv_title_2') }} </span>
        </div>
      </div> <!-- Title -->
      ...
      <div class="row">
        <div class="col text-right">
          <button type="button" class="btn btn-success suggest_1_btn Greenbtn" @click="Search_advanced"> {{ $t('index.spe_adv_btn') }} </button>
        </div>
      </div>
...
.slider_1_detail{
  direction: rtl;
  box-shadow: -49px 0 42px -40px rgba(0, 0, 0, 0.2);
}
