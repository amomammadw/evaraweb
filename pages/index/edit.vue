<template>
  <div v-show="estate_info" class="container-fluid" v-bind:class="[{'Estedad_FD_Light' : $i18n.locale=='fa' || $i18n.locale=='ar' },{'Estedad_Light' : $i18n.locale=='en' || $i18n.locale=='ru' || $i18n.locale=='tr'}]">

    <div class="row" v-if="$route.query.type === 'edit'"> <div class="col text-right"> <h2 v-bind:class="[{'Estedad_FD_Bold' : $i18n.locale=='fa' || $i18n.locale=='ar' },{'Estedad_Bold' : $i18n.locale=='en' || $i18n.locale=='ru' || $i18n.locale=='tr'}]"> {{ $t('edit_house.update_title') }} </h2> </div> </div>
    <div class="row" v-if="$route.query.type === 'edit'"> <div class="col text-right"> <p style="direction: rtl"> {{ $t('edit_house.update_desc') }} </p> </div> </div>

    <div class="row" v-if="$route.query.type === 'duplicate'"> <div class="col text-right"> <h2 v-bind:class="[{'Estedad_FD_Bold' : $i18n.locale=='fa' || $i18n.locale=='ar' },{'Estedad_Bold' : $i18n.locale=='en' || $i18n.locale=='ru' || $i18n.locale=='tr'}]"> {{ $t('edit_house.duplicate_title') }} </h2> </div> </div>
    <div class="row" v-if="$route.query.type === 'duplicate'"> <div class="col text-right"> <p style="direction: rtl"> {{ $t('edit_house.duplicate_desc') }} </p> </div> </div>
            ...
            <div class="row">
              ...
              <div class="col-12 col-xl-5 col-lg-5 text-right">
                ...
                <div class="form-group" style="margin-bottom: 1rem;">
                  ...
                  <div class="tab-content" id="adv_pills-tabContent"  v-if="quill_disabled">
              ...
              <div class="col-12 col-xl-6 col-lg-6 text-right">
                <div class="card" style="border-radius: 1.5rem;">
                  <div class="card-body map_card">
                    ...
                    <!-- Leaflet -->
                    <!--                    <l-map class="leaflet_style" style="border-radius: 1rem" :zoom="leaflet_map.zoom" :center="leaflet_map.center"-->
                    <!--                           @click="addMarker">-->
                    <!--                      <l-tile-layer :url="leaflet_map.url"></l-tile-layer>-->
                    <!--                      <l-marker :lat-lng="leaflet_address_marker.addressLatLng" @click="removeMarker"></l-marker>-->
                ...
                <div class="row"><div class="col">
                  <div class="collapse" id="collapseExample">
                    <div class="card card-body">
                      ...
                      <!--                        <div class="form-group col-md-4" v-for="(item,indx) in lst_properties">-->
                      <!--                          <label class="small_title mgn_form_label" v-if="lst_properties[indx].is_necessary === 1" datatype="required">{{lst_properties[indx].title}}</label>-->
                      <!--                          <label class="small_title mgn_form_label" v-if="lst_properties[indx].is_necessary !== 1" >{{lst_properties[indx].title}}</label>-->
                      <!--                          <select class="form-control mgn_input" :id="'property_'+lst_properties[indx].id">-->
                      <!--                            <option selected value="-1"> انتخاب کنید</option>-->
                      <!--                            <option v-for="option in lst_properties[indx].values" v-bind:value="option.value_id">-->
                      <!--                              {{option.value}}-->
                      <!--                            </option>-->
                      <!--                          </select>-->
                      <!--                        </div>-->
                  ...
                  <div class="col">
                    <div class="card images_main_card">
                      <div class="card-body">
                            ...
                            <div class="row">
                              ...
                              <div class="card add_image_card" @click="addPano()">
                                <div class="card-body">
                                  ...
                                  <div class="row"><div class="col"><i class="fas fa-cube ico_in_card"></i></div></div>
                        ...
                        <div class="row">
                          <!-- از لیست پیشفرض -->
                          <div class="col-4 col-xl-2 col-lg-2" style="margin-bottom: 35px;" v-for="(image, key) in selected_items.url_images" :key="image.url" v-if="image.is_old === 1">
                            <div class="card" style="border-radius: 9px;width: 150px;">
                              <div class="delete_ico_image" v-on:click="removeFile( key , 2 )"> <i class="far fa-trash-alt"></i> </div>
                              <img alt="EVARA" class="card-img-top image_preview" :src="image.fullUrl" />
                              <div class="order_ico_image" v-if="image.order == 200" @click="set_orders_for_images('old',key)"> - </div>
                              <div class="order_ico_image" v-if="image.order != 200" @click="set_orders_for_images('old',key)"> {{ image.order }} </div>
                            </div>
                          </div>
                          ...
                          <div class="col-4 col-xl-2 col-lg-2"  style="margin-bottom: 35px;" v-for="(image, key) in selected_items.images" :key="key">
                            <div class="card" style="border-radius: 9px;width: 150px;">
                              ...
                              <div class="order_ico_image" v-if="image.upload_status === 1 && selected_items.url_images[ selected_items.updt_url_images.length + key ].order == 200" @click="set_orders_for_images('new',key)"> - </div>
                              <div class="order_ico_image" v-if="image.upload_status === 1 && selected_items.url_images[ selected_items.updt_url_images.length + key ].order != 200" @click="set_orders_for_images('new',key)"> {{ selected_items.url_images[ selected_items.updt_url_images.length + key ].order }} </div>
                        ...
                        <div class="row">
                          ...
                          <!-- از لیست پیشفرض -->
                          <div class="col-4 col-xl-6 col-lg-6" style="margin-bottom: 35px;" v-for="(pano, key) in selected_items.updt_url_pano" :key="pano.fullurl">
                            <div class="card" style="border-radius: 9px;width: 100%;">
                              <div class="delete_ico_image" v-on:click="removePano( key , 2 )"> <i class="far fa-trash-alt"></i> </div>
                              <img alt="EVARA"  class="card-img-top image_pano_preview" :src="pano.fullurl" />
                            </div>
                          </div>

                          <!-- جدید -->
                          <div class="col-4 col-xl-6 col-lg-6" style="margin-bottom: 35px;" v-for="(pano, key3) in selected_items.pano" :key="key3">
                            <div class="card" style="border-radius: 9px;width: 100%;">
<!--                              <div v-if="pano.upload_status === 1" class="delete_ico_image" v-on:click="removePano( key3 )"> <i class="far fa-trash-alt"></i> </div>-->
                              <div class="delete_ico_image" v-on:click="removePano( key3 )"> <i class="far fa-trash-alt"></i> </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-4 col-xl-2 col-lg-2" style="margin-bottom: 35px;" v-for="(vid, key) in selected_items.updt_url_video" :key="vid.fullurl">
                            <div class="card" style="border-radius: 9px;width: fit-content;">
                              <div class="delete_ico_image" v-on:click="removeVideo( key , 2 )"> <i class="far fa-trash-alt"></i> </div>
                              <video width="150" height="150" :src="vid.fullurl" controls>
                                مرورگر شما از ویدیو پشتیبانی نمی کند
                              </video>
                            </div>
                          </div>

                          <div class="col-4 col-xl-2 col-lg-2" style="margin-bottom: 35px;" v-for="(vid, key4) in selected_items.video" :key="key4">
                            <div class="card" style="border-radius: 9px;width: fit-content;">
<!--                              <div v-if="vid.upload_status === 1" class="delete_ico_image" v-on:click="removeVideo( key4 )"> <i class="far fa-trash-alt"></i> </div>-->
                              <div class="delete_ico_image" v-on:click="removeVideo( key4 )"> <i class="far fa-trash-alt"></i> </div>
...
<!--                      <input type="text" v-mask="'###.###.###.###'" class="form-control grouped_input" maxlength="15" :id="'price_'+lst_price_type[indx].id">-->
                    ...
                    <div class="input-group text-right mb-3">
                      ...
                      <div class="input-group-prepend">
                        <select class="form-control grouped_select" v-model="selected_items.phone_sub_code">
                          <option v-bind:class="[{'Estedad_FD_Bold' : $i18n.locale=='fa' || $i18n.locale=='ar' },{'Estedad_Bold' : $i18n.locale=='en' || $i18n.locale=='ru' || $i18n.locale=='tr'}]" style="direction: ltr;" v-for="opt in list_of_country" :value="opt.id" > {{opt.area_code}} </option>
                        </select>
                      </div>
                    </div>
            ...
            <div class="row" style="margin-top: 15px;margin-bottom: 60px;">
              <div class="col text-right">
                <button v-if="$route.query.type === 'edit'" type="button" class="btn btn-success col Yes_btn" style="width: auto" @click="Save"> {{ $t('add_house.save_form') }} </button>
                <button v-if="$route.query.type === 'duplicate'" type="button" class="btn btn-success col Yes_btn" style="width: auto" @click="DuplicateSave"> {{ $t('add_house.save_form') }} </button>
                <button type="button" class="btn btn-success col no_btn" @click="newroute('/profile/myestates')">{{ $t('add_house.cancel_form') }} </button>
              </div>
            </div>
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p class="text-justify" style="padding: 15px;">
              {{ $t('add_house.rules_text') }}
            </p>
          </div>
...
export default {
  ...
  , methods: {
    ...
    , Save() {
      ...
      if (is_upload_image === true) {
      ...
      else if (this.selected_items.dealing_type == '-1') {
        this.$toast.warning(this.$t('add_house.error_6'));
      }
      else if (this.selected_items.estate_type == '-1') {
        this.$toast.warning(this.$t('add_house.error_7'));
      }
      else if (this.selected_items.land_use == '-1') {
        this.$toast.warning(this.$t('add_house.error_8'));
      }
      else if (this.selected_items.province == '-1') {
      ...
      else if (this.selected_items.rooms == '-1') {
        this.$toast.warning(this.$t('add_house.error_16'));
      }
      else if (this.selected_items.floor == '-1') {
      ...
      else if (this.selected_items.url_images.length === 0) {
        ...
        formData.append('id', this.estate_query_id);
        ...
        for( var i = 0; i < this.selected_items.url_images.length; i++ ){
          if (this.selected_items.url_images[i].is_old == 1){
            pic_aray.push({
              url : this.selected_items.url_images[i].name.split('/')[1] ,
              is_old : this.selected_items.url_images[i].is_old ,
              order  : this.selected_items.url_images[i].order ,
            });
          }else{
            pic_aray.push({
        ...
        for( var i = 0; i < this.selected_items.url_pano.length; i++ ){
          pano_aray.push({
            contex : this.selected_items.url_pano[i].url,
            is_old : this.selected_items.url_images[i].is_old,
          });
        }
        ...
        for( var i = 0; i < this.selected_items.url_video.length; i++ ){
          video_aray.push({
            contex : this.selected_items.url_video[i].url,
            is_old : this.selected_items.url_images[i].is_old,
          });
        }
        ...
        this.$axios.$post('edit_estate', formData, config)
          .then((response) => {
    ...
    , DuplicateSave() {
      ...
      else if (this.selected_items.updt_url_images.length === 0) {
        this.$toast.warning(this.$t('add_house.error_22'));
      }
      else if (this.agrement === false) {
        this.$toast.warning(this.$t('add_house.error_23'));
    ...
    , fetch_detail() {
      ...
      if (
        (this.control_center.stp_1 === true) &&
        (this.control_center.stp_2 === true) &&
        (this.control_center.stp_3 === true) &&
        (this.control_center.stp_4 === true) &&
        (this.control_center.stp_5 === true) &&
        (this.control_center.stp_6 === true) &&
        (this.control_center.stp_7 === true)
      ) {

        this.$axios.$post( 'estate_info',{
          ...
          .then((response) => {
            ...
            if (response[0].res === 1) {
              ...
              //province
              this.selected_items.province = this.estate_info.state_id;

              //City && Neighbourhood
              this.fetch_city(this.estate_info.city_id,this.estate_info.neghbourhod_id,this.estate_info.alley_id)

              //Title
              this.selected_items.ads_title_fa = this.estate_info.public_title_fa;
              this.selected_items.ads_title_en = this.estate_info.public_title_en;
              this.selected_items.ads_title_ar = this.estate_info.public_title_ar;
              this.selected_items.ads_title_ch = this.estate_info.public_title_ch;
              this.selected_items.ads_title_ru = this.estate_info.public_title_ru;
              this.selected_items.ads_title_tr = this.estate_info.public_title_tr;


              //Special Title
              this.selected_items.ads_title_fa_sp = this.estate_info.special_title_fa;
              this.selected_items.ads_title_en_sp = this.estate_info.special_title_en;
              this.selected_items.ads_title_ar_sp = this.estate_info.special_title_ar;
              this.selected_items.ads_title_ch_sp = this.estate_info.special_title_ch;
              this.selected_items.ads_title_ru_sp = this.estate_info.special_title_ru;
              this.selected_items.ads_title_tr_sp = this.estate_info.special_title_tr;


              //Editor
              this.selected_items.editorData_fa = this.estate_info.desc_fa;
              this.selected_items.editorData_en = this.estate_info.desc_en;
              this.selected_items.editorData_tr = this.estate_info.desc_tr;
              this.selected_items.editorData_ch = this.estate_info.desc_ch;
              this.selected_items.editorData_ar = this.estate_info.desc_ar;
              this.selected_items.editorData_ru = this.estate_info.desc_ru;

              this.quill_disabled = true;

              //Mobile
              this.selected_items.mobile = this.estate_info.address[0].mobile;

              //Tel
              this.selected_items.tel = this.estate_info.address[0].tel;

              //Mobile Code
              this.selected_items.mobile_sub_code = this.estate_info.address[0].area_code_mobile_id;

              //Tel Code
              this.selected_items.phone_sub_code = this.estate_info.address[0].area_code_tel_id;

              //Postal Code
              this.selected_items.postal_code = this.estate_info.postal_code;

              //Area Space
              this.selected_items.area_space = this.estate_info.area_space;

              //IFrame 360
              this.selected_items.iframe_360 = this.estate_info.iframe_360;

              //matterport
              this.selected_items.matterport_modelsid = this.estate_info.matterport_modelsid;

              //Desc
              this.selected_items.desc = this.estate_info.comment;

              //Dealing Type
              this.selected_items.dealing_type = this.estate_info.dealing_type_id;

              //Estate Type
              this.selected_items.estate_type = this.estate_info.estate_type_id;

              //Land Use
              this.selected_items.land_use = this.estate_info.land_use_id;

              //Area Space
              this.selected_items.area_space_all = this.estate_info.area_space_all;
              this.selected_items.area_space_real = this.estate_info.area_space_real;

              //Floor And Room
              this.selected_items.floor = this.estate_info.floor_number_id;
              this.selected_items.rooms = this.estate_info.room_number_id;

              //MAP
              var coor_array = this.estate_info.address[0].location.toString().split(",");
              this.leaflet_address_marker.addressLatLng = coor_array;
              this.leaflet_address_marker.hasmarker = true;
              this.leaflet_map.center = this.estate_info.address[0].location.toString().split(",");

              this.google_map_center = {lat: parseFloat(coor_array[0]), lng: parseFloat(coor_array[1])};
              this.google_address_marker.addressLatLng = {lat: parseFloat(coor_array[0]), lng: parseFloat(coor_array[1])};
              this.google_address_marker.hasmarker = true;

              //Address
              this.set_map_address(coor_array[0],coor_array[1]);
              this.selected_items.address = this.estate_info.address[0].address;

              //Prices
              for (var i=0; i < this.estate_info.prices.length ; i++){
                var price_id = this.estate_info.prices[i].price_type_id;
                var unit_id = this.estate_info.prices[i].unit_id;

                $( "#price_"+price_id ).val(this.estate_info.prices[i].price_value);
                $( "#unit_price_"+price_id ).val(unit_id);
              }

              //Properties
              for (var i=0; i < this.estate_info.properties.length ; i++){
                var property_value = this.estate_info.properties[i].property_value;
                var property_id = this.estate_info.properties[i].property_id;
                var property_is_list = this.estate_info.properties[i].property_is_list;


                if (property_is_list === 1){
                  for (var j=0; j < property_value.length ; j++){
                    var value_id = property_value[j].property_value_id;
                    if (property_value[j].is_exist === 1){
                      $('#slc_property_'+property_id).val(value_id)
                    }
                  }
                }else{
                  for (var j=0; j < property_value.length ; j++){
                    var value_id = property_value[j].property_value_id;
                    if (property_value[j].is_exist === 1){
                      $( "#check_bx_"+value_id).prop('checked', true);
                    }
                  }
                }
              }
              ...
              for (var i=0; i < this.estate_info.galleris.length ; i++){
                this.selected_items.updt_url_images.push({
                  fullurl : this.estate_info.galleris[i].img ,
                  name : this.estate_info.galleris[i].img_name ,
                  order : this.estate_info.galleris[i].order ,
                  is_old : 1 ,
                })

                this.selected_items.url_images.push({
                  url : this.estate_info.galleris[i].img_name.split('/')[1] ,
                  fullUrl : this.estate_info.galleris[i].img ,
                  name : this.estate_info.galleris[i].img_name ,
                  order : this.estate_info.galleris[i].order ,
                  is_old : 1 ,
              ...
              //Panorama
              for (var i=0; i < this.estate_info.pics_360.length ; i++){
                this.selected_items.updt_url_pano.push({
                  fullurl : this.estate_info.pics_360[i].pano ,
                  is_old : 1 ,
                })

                this.selected_items.url_pano.push({
                  url : this.estate_info.pics_360[i].pano_name ,
                  is_old : 1 ,
                })
              }

              //Video
              for (var i=0; i < this.estate_info.videos.length ; i++){
                this.selected_items.updt_url_video.push({
                  fullurl : this.estate_info.videos[i].video ,
                  is_old : 1 ,
                })

                this.selected_items.url_video.push({
                  url : this.estate_info.videos[i].video_name ,
                  is_old : 1 ,
                })
              }
    ...
    , fetch_city(prevent = -1,neighbourhood_prevent = -1,alley_prevent = -1) {
      ...
      if (this.selected_items.province === '-1') {
        ...
        this.$axios.$post('list_of_city', {
          ...
          .then((response) => {
            ...
            if (prevent != -1){
              this.selected_items.city = prevent;
              if (neighbourhood_prevent != -1)
                this.fetch_neighbourhood(neighbourhood_prevent,alley_prevent);
            }
            if (response[0].res === -5) this.DestroyStorage();
          })
          .catch((error) => {
    ...
    , fetch_neighbourhood(prevent = -1,alley_prevent = -1) {
      this.lst_alley = [];
      ...
      if (this.selected_items.city === '-1') {
        ...
        this.$axios.$post('list_of_neghbourhod', {
          ...
          .then((response) => {
            ...
            if (prevent != -1){
              this.selected_items.neighbourhood = prevent;
              if (alley_prevent != -1)
                this.fetch_alley(alley_prevent);
            }
            if (response[0].res === -5) this.DestroyStorage();
          })
          .catch((error) => {
      ...
      if (this.selected_items.neighbourhood === '-1') {
        ...
        this.$axios.$post('list_of_alley', {
          ...
          .then((response) => {
            ...
            if (prevent != -1){
              this.selected_items.slc_alley = prevent;
            }
            if (response[0].res === -5) this.DestroyStorage();
          })
          .catch((error) => {
    ...
    , removeMarker() {
      this.leaflet_address_marker.hasmarker = false;
      this.leaflet_address_marker.addressLatLng = [0, 0];
    }
    , addMarker(event) {
      this.leaflet_address_marker.hasmarker = true;
      this.leaflet_address_marker.addressLatLng = [event.latlng.lat, event.latlng.lng];
    ...
    , removeFile( key,type = 1){
      if (type === 1){
        ...
        this.selected_items.url_images.splice( key, 1 );
        this.selected_items.updt_url_images.splice( key, 1 );
      }
    }
    , onFileChange(e) {
      let vm = this;
      ...
      for (let i = 0; i < selectedFiles.length; i++) {
        if (this.selected_items.images.length < 20){
          ...
          if (selectedFiles[i].size <= 20000000 && (selectedFiles[i].type === 'image/jpeg' || selectedFiles[i].type === 'image/jpg') ) {
            ...
            this.$toast.warning(this.$t('edit.alert_file_size_1'));
          }
        }
        else {
          this.$toast.warning(this.$t('edit.alert_4'));
        }
      }
    ...
    , removeVideo( key,type = 1){
      if (type === 1){
        ...
        this.selected_items.url_video.splice( key, 1 );
        this.selected_items.updt_url_video.splice( key, 1 );
      }
    }
    , onVideoChange(e) {
      let vm = this;
    ...
    , removePano( key,type = 1){
      if (type === 1){
        ...
        this.selected_items.url_pano.splice( key, 1 );
        this.selected_items.updt_url_pano.splice( key, 1 );
      }
    }
    , onPanoChange(e) {
      let vm = this;
    ...
    , set_orders_for_images(type , indx){
      if (type == 'new'){
        indx = this.selected_items.updt_url_images.length + parseInt(indx)
      }
      if (indx <= this.selected_items.url_images.length){
        var img_order = this.selected_items.url_images[indx].order;
        if (img_order != '200') {
          this.selected_items.url_images[indx].order = 200;
        }else{
          var new_order = 0;
          var flag = false;
          while (flag === false){
            ...
            for (var i = 0 ; i < this.selected_items.url_images.length; i++){
              ...
              var img_in_list_order = this.selected_items.url_images[i].order;
          ...
          this.selected_items.url_images[indx].order = new_order;
        }
      }
    }
  }
  , mounted() {
    ...
    if(this.$route.query.estate) {
      window.scrollTo(0,0);
      this.estate_query_id = this.$route.query.estate;
      this.auth();
    }else {
      this.newroute('/profile/myestates');
    }
